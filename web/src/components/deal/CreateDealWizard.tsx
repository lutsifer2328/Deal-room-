                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setPrice(raw ? Number(raw).toLocaleString('en-US') : '');
                                        }}
                                        placeholder="250,000"
                                        className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-teal focus:border-teal outline-none"
                                    />
                                </div>
                            </div>
                        </div>
